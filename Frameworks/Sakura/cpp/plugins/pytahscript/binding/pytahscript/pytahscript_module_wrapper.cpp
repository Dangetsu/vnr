...
PyTypeObject** SbkpytahscriptTypes;
// Current module's converter array.
SbkConverter** SbkpytahscriptTypeConverters;
void cleanTypesAttributes(void) {
    for (int i = 0, imax = SBK_pytahscript_IDX_COUNT; i < imax; i++) {
        PyObject *pyType = reinterpret_cast<PyObject*>(SbkpytahscriptTypes[i]);
...
static PyMethodDef pytahscript_methods[] = {
    {0} // Sentinel
};
...
#endif
SBK_MODULE_INIT_FUNCTION_BEGIN(pytahscript)
    {
    ...
    static PyTypeObject* cppApi[SBK_pytahscript_IDX_COUNT];
    SbkpytahscriptTypes = cppApi;

    // Create an array of primitive type converters for the current module.
    static SbkConverter* sbkConverters[SBK_pytahscript_CONVERTERS_IDX_COUNT];
    SbkpytahscriptTypeConverters = sbkConverters;

#ifdef IS_PY3K
    PyObject* module = Shiboken::Module::create("pytahscript", &moduledef);
#else
    PyObject* module = Shiboken::Module::create("pytahscript", pytahscript_methods);
#endif

    // Initialize classes in the type system
    init_TahScriptManager(module);

    // Register converter for type 'QList<QVariant>'.
    SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QLIST_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QVariant__CppToPython__QList_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QLIST_QVARIANT_IDX], "QList<QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QLIST_QVARIANT_IDX],
        _QList_QVariant__PythonToCpp__QList_QVariant_,
        is__QList_QVariant__PythonToCpp__QList_QVariant__Convertible);

    // Register converter for type 'QList<QString>'.
    SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QLIST_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QString__CppToPython__QList_QString_);
    Shiboken::Conversions::registerConverterName(SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QLIST_QSTRING_IDX], "QList<QString>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QLIST_QSTRING_IDX],
        _QList_QString__PythonToCpp__QList_QString_,
        is__QList_QString__PythonToCpp__QList_QString__Convertible);

    // Register converter for type 'QMap<QString,QVariant>'.
    SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QMAP_QSTRING_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyDict_Type, _QMap_QString_QVariant__CppToPython__QMap_QString_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QMAP_QSTRING_QVARIANT_IDX], "QMap<QString,QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpytahscriptTypeConverters[SBK_PYTAHSCRIPT_QMAP_QSTRING_QVARIANT_IDX],
    ...
    Shiboken::Module::registerTypes(module, SbkpytahscriptTypes);
    Shiboken::Module::registerTypeConverters(module, SbkpytahscriptTypeConverters);

    if (PyErr_Occurred()) {
        PyErr_Print();
        Py_FatalError("can't initialize module pytahscript");
    }
