...
PyTypeObject** SbkpyhanvietTypes;
// Current module's converter array.
SbkConverter** SbkpyhanvietTypeConverters;
void cleanTypesAttributes(void) {
    for (int i = 0, imax = SBK_pyhanviet_IDX_COUNT; i < imax; i++) {
        PyObject *pyType = reinterpret_cast<PyObject*>(SbkpyhanvietTypes[i]);
...
static PyMethodDef pyhanviet_methods[] = {
    {0} // Sentinel
};
...
static PyObject* _QList_QPair_QString_QString___CppToPython__QList_QPair_QString_QString__(const void* cppIn) {
    ::QList<QPair<QString, QString > >& cppInRef = *((::QList<QPair<QString, QString > >*)cppIn);
        ...
        for (int idx = 0; it != cppInRef.end(); ++it, ++idx) {
            ...
            PyList_SET_ITEM(pyOut, idx, Shiboken::Conversions::copyToPython(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QSTRING_IDX], &cppItem));
        }
        return pyOut;
...
static void _QList_QPair_QString_QString___PythonToCpp__QList_QPair_QString_QString__(PyObject* pyIn, void* cppOut) {
    ...
    for (int i = 0; i < PySequence_Size(pyIn); i++) {
        ...
        Shiboken::Conversions::pythonToCppCopy(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QSTRING_IDX], pyItem, &(cppItem));
        cppOutRef << cppItem;
    }
...
static PythonToCppFunc is__QList_QPair_QString_QString___PythonToCpp__QList_QPair_QString_QString___Convertible(PyObject* pyIn) {
    if (Shiboken::Conversions::convertibleSequenceTypes(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QSTRING_IDX], pyIn))
        return _QList_QPair_QString_QString___PythonToCpp__QList_QPair_QString_QString__;
    return 0;
}

// C++ to Python conversion for type 'QPair<QString, QList<QPair<QString, QString > > >'.
static PyObject* _QPair_QString_QList_QPair_QString_QString____CppToPython__QPair_QString_QList_QPair_QString_QString___(const void* cppIn) {
    ::QPair<QString, QList<QPair<QString, QString > > >& cppInRef = *((::QPair<QString, QList<QPair<QString, QString > > >*)cppIn);

            PyObject* pyOut = PyTuple_New(2);
            PyTuple_SET_ITEM(pyOut, 0, Shiboken::Conversions::copyToPython(SbkPySide_QtCoreTypeConverters[SBK_QSTRING_IDX], &cppInRef.first));
            PyTuple_SET_ITEM(pyOut, 1, Shiboken::Conversions::copyToPython(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QPAIR_QSTRING_QSTRING_IDX], &cppInRef.second));
            return pyOut;

}
static void _QPair_QString_QList_QPair_QString_QString____PythonToCpp__QPair_QString_QList_QPair_QString_QString___(PyObject* pyIn, void* cppOut) {
    ::QPair<QString, QList<QPair<QString, QString > > >& cppOutRef = *((::QPair<QString, QList<QPair<QString, QString > > >*)cppOut);

            Shiboken::Conversions::pythonToCppCopy(SbkPySide_QtCoreTypeConverters[SBK_QSTRING_IDX], PySequence_Fast_GET_ITEM(pyIn, 0), &(cppOutRef.first));
            Shiboken::Conversions::pythonToCppCopy(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QPAIR_QSTRING_QSTRING_IDX], PySequence_Fast_GET_ITEM(pyIn, 1), &(cppOutRef.second));

}
static PythonToCppFunc is__QPair_QString_QList_QPair_QString_QString____PythonToCpp__QPair_QString_QList_QPair_QString_QString____Convertible(PyObject* pyIn) {
    if (Shiboken::Conversions::convertiblePairTypes(SbkPySide_QtCoreTypeConverters[SBK_QSTRING_IDX], false, SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QPAIR_QSTRING_QSTRING_IDX], false, pyIn))
        return _QPair_QString_QList_QPair_QString_QString____PythonToCpp__QPair_QString_QList_QPair_QString_QString___;
    return 0;
}
...
#endif
SBK_MODULE_INIT_FUNCTION_BEGIN(pyhanviet)
    {
    ...
    static PyTypeObject* cppApi[SBK_pyhanviet_IDX_COUNT];
    SbkpyhanvietTypes = cppApi;

    // Create an array of primitive type converters for the current module.
    static SbkConverter* sbkConverters[SBK_pyhanviet_CONVERTERS_IDX_COUNT];
    SbkpyhanvietTypeConverters = sbkConverters;

#ifdef IS_PY3K
    PyObject* module = Shiboken::Module::create("pyhanviet", &moduledef);
#else
    PyObject* module = Shiboken::Module::create("pyhanviet", pyhanviet_methods);
#endif

    // Initialize classes in the type system
    init_HanVietTranslator(module);

    // Register converter for type 'QPair<QString,QString>'.
    SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QPair_QString_QString__CppToPython__QPair_QString_QString_);
    Shiboken::Conversions::registerConverterName(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QSTRING_IDX], "QPair<QString,QString>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QSTRING_IDX],
    ...
    SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QPAIR_QSTRING_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QPair_QString_QString___CppToPython__QList_QPair_QString_QString__);
    Shiboken::Conversions::registerConverterName(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QPAIR_QSTRING_QSTRING_IDX], "QList<QPair<QString,QString>>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QPAIR_QSTRING_QSTRING_IDX],
    ...
    // Register converter for type 'QPair<QString,QList<QPair<QString,QString>>>'.
    SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QLIST_QPAIR_QSTRING_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QPair_QString_QList_QPair_QString_QString____CppToPython__QPair_QString_QList_QPair_QString_QString___);
    Shiboken::Conversions::registerConverterName(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QLIST_QPAIR_QSTRING_QSTRING_IDX], "QPair<QString,QList<QPair<QString,QString>>>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QPAIR_QSTRING_QLIST_QPAIR_QSTRING_QSTRING_IDX],
        _QPair_QString_QList_QPair_QString_QString____PythonToCpp__QPair_QString_QList_QPair_QString_QString___,
        is__QPair_QString_QList_QPair_QString_QString____PythonToCpp__QPair_QString_QList_QPair_QString_QString____Convertible);

    // Register converter for type 'QList<QVariant>'.
    SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QVariant__CppToPython__QList_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QVARIANT_IDX], "QList<QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QVARIANT_IDX],
        _QList_QVariant__PythonToCpp__QList_QVariant_,
        is__QList_QVariant__PythonToCpp__QList_QVariant__Convertible);

    // Register converter for type 'QList<QString>'.
    SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QString__CppToPython__QList_QString_);
    Shiboken::Conversions::registerConverterName(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QSTRING_IDX], "QList<QString>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QLIST_QSTRING_IDX],
        _QList_QString__PythonToCpp__QList_QString_,
        is__QList_QString__PythonToCpp__QList_QString__Convertible);

    // Register converter for type 'QMap<QString,QVariant>'.
    SbkpyhanvietTypeConverters[SBK_PYHANVIET_QMAP_QSTRING_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyDict_Type, _QMap_QString_QVariant__CppToPython__QMap_QString_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QMAP_QSTRING_QVARIANT_IDX], "QMap<QString,QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyhanvietTypeConverters[SBK_PYHANVIET_QMAP_QSTRING_QVARIANT_IDX],
    ...
    Shiboken::Module::registerTypes(module, SbkpyhanvietTypes);
    Shiboken::Module::registerTypeConverters(module, SbkpyhanvietTypeConverters);

    if (PyErr_Occurred()) {
        PyErr_Print();
        Py_FatalError("can't initialize module pyhanviet");
    }
