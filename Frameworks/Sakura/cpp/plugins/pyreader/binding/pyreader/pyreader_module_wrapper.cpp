...
PyTypeObject** SbkpyreaderTypes;
// Current module's converter array.
SbkConverter** SbkpyreaderTypeConverters;
void cleanTypesAttributes(void) {
    for (int i = 0, imax = SBK_pyreader_IDX_COUNT; i < imax; i++) {
        PyObject *pyType = reinterpret_cast<PyObject*>(SbkpyreaderTypes[i]);
...
static PyMethodDef pyreader_methods[] = {
    {0} // Sentinel
};
...
#endif
SBK_MODULE_INIT_FUNCTION_BEGIN(pyreader)
    {
    ...
    static PyTypeObject* cppApi[SBK_pyreader_IDX_COUNT];
    SbkpyreaderTypes = cppApi;

    // Create an array of primitive type converters for the current module.
    static SbkConverter* sbkConverters[SBK_pyreader_CONVERTERS_IDX_COUNT];
    SbkpyreaderTypeConverters = sbkConverters;

#ifdef IS_PY3K
    PyObject* module = Shiboken::Module::create("pyreader", &moduledef);
#else
    PyObject* module = Shiboken::Module::create("pyreader", pyreader_methods);
#endif
    ...
    Shiboken::Conversions::registerConverterName(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QOBJECTPTR_IDX], "const QList<QObject*>&");
    Shiboken::Conversions::registerConverterName(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QOBJECTPTR_IDX], "QList<QObject*>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QOBJECTPTR_IDX],
    ...
    SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QBYTEARRAY_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QByteArray__CppToPython__QList_QByteArray_);
    Shiboken::Conversions::registerConverterName(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QBYTEARRAY_IDX], "QList<QByteArray>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QBYTEARRAY_IDX],
    ...
    SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QVariant__CppToPython__QList_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QVARIANT_IDX], "QList<QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QVARIANT_IDX],
        _QList_QVariant__PythonToCpp__QList_QVariant_,
        is__QList_QVariant__PythonToCpp__QList_QVariant__Convertible);

    // Register converter for type 'QList<QString>'.
    SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QSTRING_IDX] = Shiboken::Conversions::createConverter(&PyList_Type, _QList_QString__CppToPython__QList_QString_);
    Shiboken::Conversions::registerConverterName(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QSTRING_IDX], "QList<QString>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyreaderTypeConverters[SBK_PYREADER_QLIST_QSTRING_IDX],
        _QList_QString__PythonToCpp__QList_QString_,
        is__QList_QString__PythonToCpp__QList_QString__Convertible);

    // Register converter for type 'QMap<QString,QVariant>'.
    SbkpyreaderTypeConverters[SBK_PYREADER_QMAP_QSTRING_QVARIANT_IDX] = Shiboken::Conversions::createConverter(&PyDict_Type, _QMap_QString_QVariant__CppToPython__QMap_QString_QVariant_);
    Shiboken::Conversions::registerConverterName(SbkpyreaderTypeConverters[SBK_PYREADER_QMAP_QSTRING_QVARIANT_IDX], "QMap<QString,QVariant>");
    Shiboken::Conversions::addPythonToCppValueConversion(SbkpyreaderTypeConverters[SBK_PYREADER_QMAP_QSTRING_QVARIANT_IDX],
    ...
    Shiboken::Module::registerTypes(module, SbkpyreaderTypes);
    Shiboken::Module::registerTypeConverters(module, SbkpyreaderTypeConverters);

    if (PyErr_Occurred()) {
        PyErr_Print();
        Py_FatalError("can't initialize module pyreader");
    }
