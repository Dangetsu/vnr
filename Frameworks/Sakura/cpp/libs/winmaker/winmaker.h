...
bool wm_register_hidden_class(const char *className = "hidden_class");

wm_window_t wm_create_hidden_window(
    const char * windowName = "hidden_window",
    const char * className = "Button", // bust be one of the common control widgets
