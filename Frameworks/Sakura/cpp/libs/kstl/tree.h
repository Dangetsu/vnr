...
{
  typedef _Tree_node_base _Self;
  // Not zero-ed after init.

  _Self *_M_parent;
  _Self *_M_prev, *_M_next;  // siblings
  _Self *_M_first, *_M_last; // children
...
template<typename _Tp, typename _Alloc>
  ...
  {
  protected:
    typedef typename _Alloc::template rebind<_Tree_node<_Tp> >::other
      _Node_alloc_type;
    ...
    {
      _Tree_node_base _M_node;

      _Tree_impl()
      : _Node_alloc_type(), _M_node()
      {}

      _Tree_impl(const _Node_alloc_type& __a)
...
template<typename _Tp, typename _Alloc = allocator<_Tp> >
  class tree : protected _Tree_base<_Tp, _Alloc>
  {
    typedef tree<_Tp, _Alloc> _Self;
    typedef _Tree_base<_Tp, _Alloc> _Base;
  ...
  public:
    ...
    //typedef _Tree_const_iterator<_Tp>                 const_iterator;
