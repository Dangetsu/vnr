...
Rectangle { id: root_
  ...
  property Gradient grooveGradient: Gradient { // blue
  ...
  Share.FadingRectangle { id: leftGroove_
    anchors {
      left: parent.left
      right: root_.startValue < root_.stopValue ? startHandle_.left : stopHandle_.left
      top: parent.top
  ...
  Share.FadingRectangle { //id: leftGroove_
    anchors {
      left: root_.startValue < root_.stopValue ? stopHandle_.right : startHandle_.right
      right: parent.right
      top: parent.top
      bottom: parent.bottom
      margins: 1
  ...
  Share.FadingRectangle { //id: middleGroove_
    anchors {
      left: root_.startValue < root_.stopValue ? startHandle_.right : stopHandle_.right
      right: root_.startValue < root_.stopValue ? stopHandle_.left : startHandle_.left
      top: parent.top
      bottom: parent.bottom
      margins: 1
    }
